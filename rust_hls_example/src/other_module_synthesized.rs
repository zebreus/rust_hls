...
// rust_hls hash: "e7934e21b2667afc704c4be75bcebb3"

use ::rust_hdl::prelude::*;
#[allow(dead_code, unused)]
mod other_function_verilated {
    use std::path::Path;
    mod ffi {
        #[allow(non_camel_case_types)]
        pub enum other_function {}
        extern {
            pub fn other_function_new() -> *mut other_function;
            pub fn other_function_delete(other_function: *mut other_function);
            pub fn other_function_eval(other_function: *mut other_function);
            pub fn other_function_final(other_function: *mut other_function);
            pub fn other_function_set_clk(
                other_function: *mut other_function,
                v: ::std::os::raw::c_uchar,
            );
            pub fn other_function_set_reset(
                other_function: *mut other_function,
                v: ::std::os::raw::c_uchar,
            );
            pub fn other_function_set_start_port(
                other_function: *mut other_function,
                v: ::std::os::raw::c_uchar,
            );
            pub fn other_function_set_Pd5(
                other_function: *mut other_function,
                v: ::std::os::raw::c_uint,
            );
            pub fn other_function_set_Pd6(
                other_function: *mut other_function,
                v: ::std::os::raw::c_uint,
            );
            pub fn other_function_get_done_port(
                other_function: *mut other_function,
            ) -> ::std::os::raw::c_uchar;
            pub fn other_function_get_return_port(
                other_function: *mut other_function,
            ) -> ::std::os::raw::c_uint;
        }
    }
    pub struct OtherFunctionVerilated(*mut ffi::other_function, Option<u32>);
    impl Default for OtherFunctionVerilated {
        fn default() -> Self {
            let ptr = unsafe { ffi::other_function_new() };
            assert!(! ptr.is_null());
            OtherFunctionVerilated(ptr, None)
        }
    }
    impl Drop for OtherFunctionVerilated {
        fn drop(&mut self) {
            unsafe {
                ffi::other_function_delete(self.0);
            }
        }
    }
    #[allow(dead_code, non_snake_case)]
    impl OtherFunctionVerilated {
        pub fn set_clk(&mut self, v: u8) {
            unsafe {
                ffi::other_function_set_clk(self.0, v);
            }
        }
        pub fn set_reset(&mut self, v: u8) {
            unsafe {
                ffi::other_function_set_reset(self.0, v);
            }
        }
        pub fn set_start_port(&mut self, v: u8) {
            unsafe {
                ffi::other_function_set_start_port(self.0, v);
            }
        }
        pub fn set_Pd5(&mut self, v: u32) {
            unsafe {
                ffi::other_function_set_Pd5(self.0, v);
            }
        }
        pub fn set_Pd6(&mut self, v: u32) {
            unsafe {
                ffi::other_function_set_Pd6(self.0, v);
            }
        }
        pub fn done_port(&self) -> u8 {
            unsafe { ffi::other_function_get_done_port(self.0) }
        }
        pub fn return_port(&self) -> u32 {
            unsafe { ffi::other_function_get_return_port(self.0) }
        }
        pub fn eval(&mut self) {
            unsafe {
                ffi::other_function_eval(self.0);
            }
        }
        pub fn finish(&mut self) {
            unsafe {
                ffi::other_function_final(self.0);
            }
        }
...
pub struct OtherFunction {
    ...
    verilated_module: ::std::sync::Arc<
        ::std::sync::Mutex<self::other_function_verilated::OtherFunctionVerilated>,
    >,
}
unsafe impl Send for OtherFunction {}
#[automatically_derived]
impl ::rust_hdl::prelude::block::Block for OtherFunction {
...
#[automatically_derived]
impl ::rust_hdl::prelude::Logic for OtherFunction {
    fn update(&mut self) {
    ...
    fn hdl(&self) -> ::rust_hdl::prelude::Verilog {
        ::rust_hdl::prelude::Verilog::Wrapper(::rust_hdl::prelude::Wrapper {
            code: "other_function other_function_inst(.clk(clk), .reset(reset), .start_port(start_port), .Pd5(a), .Pd6(b), .done_port(done_port), .return_port(return_port));"
                .into(),
