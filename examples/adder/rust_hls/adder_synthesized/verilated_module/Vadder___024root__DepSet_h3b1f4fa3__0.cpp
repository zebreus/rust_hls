...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpY1PzQD/test.v", 197, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpY1PzQD/test.v", 197, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpY1PzQD/test.v", 197, "", "Active region did not converge.");
            }
