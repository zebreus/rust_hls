...
VL_ATTR_COLD void Vmultiplier___024root___eval_static__TOP(Vmultiplier___024root* vlSelf) {
    ...
    // Body
    vlSelf->multiplier__DOT___multiplier_i0__DOT__Controller_i__DOT___present_state = 1U;
}
...
VL_ATTR_COLD void Vmultiplier___024root___eval_initial__TOP(Vmultiplier___024root* vlSelf) {
    ...
    // Body
    vlSelf->multiplier__DOT___multiplier_i0__DOT__Controller_i__DOT___next_state = 1U;
}
...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmp4QWQnc/test.v", 235, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vmultiplier___024root___ctor_var_reset(Vmultiplier___024root* vlSelf) {
    ...
    vlSelf->multiplier__DOT___multiplier_i0__DOT__Controller_i__DOT___present_state = VL_RAND_RESET_I(1);
    vlSelf->multiplier__DOT___multiplier_i0__DOT__Controller_i__DOT___next_state = VL_RAND_RESET_I(1);
