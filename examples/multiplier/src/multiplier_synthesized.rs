...
// rust_hls hash: "41b75fe92a56a92b3ea516b6becb06fe"

use ::rust_hdl::prelude::*;
#[allow(dead_code, unused)]
mod multiplier_verilated {
    use std::path::Path;
    mod ffi {
        #[allow(non_camel_case_types)]
        pub enum multiplier {}
        extern {
            pub fn multiplier_new() -> *mut multiplier;
            pub fn multiplier_delete(multiplier: *mut multiplier);
            pub fn multiplier_eval(multiplier: *mut multiplier);
            pub fn multiplier_final(multiplier: *mut multiplier);
            pub fn multiplier_set_clk(
                multiplier: *mut multiplier,
                v: ::std::os::raw::c_uchar,
            );
            pub fn multiplier_set_reset(
                multiplier: *mut multiplier,
                v: ::std::os::raw::c_uchar,
            );
            pub fn multiplier_set_start_port(
                multiplier: *mut multiplier,
                v: ::std::os::raw::c_uchar,
            );
            pub fn multiplier_set_Pd5(
                multiplier: *mut multiplier,
                v: ::std::os::raw::c_uint,
            );
            pub fn multiplier_set_Pd6(
                multiplier: *mut multiplier,
                v: ::std::os::raw::c_uint,
            );
            pub fn multiplier_get_done_port(
                multiplier: *mut multiplier,
            ) -> ::std::os::raw::c_uchar;
            pub fn multiplier_get_return_port(
                multiplier: *mut multiplier,
            ) -> ::std::os::raw::c_uint;
        }
    }
    pub struct MultiplierVerilated(*mut ffi::multiplier, Option<u32>);
    impl Default for MultiplierVerilated {
        fn default() -> Self {
            let ptr = unsafe { ffi::multiplier_new() };
            assert!(! ptr.is_null());
            MultiplierVerilated(ptr, None)
        }
    }
    impl Drop for MultiplierVerilated {
        fn drop(&mut self) {
            unsafe {
                ffi::multiplier_delete(self.0);
            }
        }
    }
    #[allow(dead_code, non_snake_case)]
    impl MultiplierVerilated {
        pub fn set_clk(&mut self, v: u8) {
            unsafe {
                ffi::multiplier_set_clk(self.0, v);
            }
        }
        pub fn set_reset(&mut self, v: u8) {
            unsafe {
                ffi::multiplier_set_reset(self.0, v);
            }
        }
        pub fn set_start_port(&mut self, v: u8) {
            unsafe {
                ffi::multiplier_set_start_port(self.0, v);
            }
        }
        pub fn set_Pd5(&mut self, v: u32) {
            unsafe {
                ffi::multiplier_set_Pd5(self.0, v);
            }
        }
        pub fn set_Pd6(&mut self, v: u32) {
            unsafe {
                ffi::multiplier_set_Pd6(self.0, v);
            }
        }
        pub fn done_port(&self) -> u8 {
            unsafe { ffi::multiplier_get_done_port(self.0) }
        }
        pub fn return_port(&self) -> u32 {
            unsafe { ffi::multiplier_get_return_port(self.0) }
        }
        pub fn eval(&mut self) {
            unsafe {
                ffi::multiplier_eval(self.0);
            }
        }
        pub fn finish(&mut self) {
            unsafe {
                ffi::multiplier_final(self.0);
            }
        }
...
pub struct Multiplier {
    ...
    verilated_module: ::std::sync::Arc<
        ::std::sync::Mutex<self::multiplier_verilated::MultiplierVerilated>,
    >,
}
unsafe impl Send for Multiplier {}
#[automatically_derived]
impl ::rust_hdl::prelude::block::Block for Multiplier {
...
#[automatically_derived]
impl ::rust_hdl::prelude::Logic for Multiplier {
    fn update(&mut self) {
    ...
    fn hdl(&self) -> ::rust_hdl::prelude::Verilog {
        ::rust_hdl::prelude::Verilog::Wrapper(::rust_hdl::prelude::Wrapper {
            code: "multiplier multiplier_inst(.clk(clk), .reset(reset), .start_port(start_port), .Pd5(a), .Pd6(b), .done_port(done_port), .return_port(return_port));"
                .into(),
