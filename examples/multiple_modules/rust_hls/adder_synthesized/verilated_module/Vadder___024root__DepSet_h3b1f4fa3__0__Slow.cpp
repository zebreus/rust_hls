...
VL_ATTR_COLD void Vadder___024root___eval_static__TOP(Vadder___024root* vlSelf);
...
VL_ATTR_COLD void Vadder___024root___eval_static(Vadder___024root* vlSelf) {
    ...
    // Body
    Vadder___024root___eval_static__TOP(vlSelf);
}

VL_ATTR_COLD void Vadder___024root___eval_static__TOP(Vadder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vadder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vadder___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->adder__DOT___adder_i0__DOT__Controller_i__DOT___present_state = 1U;
}
...
VL_ATTR_COLD void Vadder___024root___eval_initial__TOP(Vadder___024root* vlSelf) {
    ...
    // Body
    vlSelf->adder__DOT___adder_i0__DOT__Controller_i__DOT___next_state = 1U;
}
...
VL_ATTR_COLD void Vadder___024root___ctor_var_reset(Vadder___024root* vlSelf) {
    ...
    vlSelf->adder__DOT___adder_i0__DOT__Controller_i__DOT___present_state = VL_RAND_RESET_I(1);
    vlSelf->adder__DOT___adder_i0__DOT__Controller_i__DOT___next_state = VL_RAND_RESET_I(1);
