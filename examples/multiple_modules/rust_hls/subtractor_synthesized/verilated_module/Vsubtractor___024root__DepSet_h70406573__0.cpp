...
VL_INLINE_OPT void Vsubtractor___024root___ico_sequent__TOP__0(Vsubtractor___024root* vlSelf) {
    ...
    // Body
    vlSelf->done_port = 0U;
    if (vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___present_state) {
...
VL_INLINE_OPT void Vsubtractor___024root___nba_sequent__TOP__0(Vsubtractor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root___nba_sequent__TOP__0\n"); );
    // Body
    vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___present_state 
        = (1U & ((~ (IData)(vlSelf->reset)) | (IData)(vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___next_state)));
    vlSelf->done_port = 0U;
    if (vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___present_state) {
        if (vlSelf->start_port) {
            vlSelf->done_port = 1U;
...
void Vsubtractor___024root___eval_nba(Vsubtractor___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vsubtractor___024root___nba_sequent__TOP__0(vlSelf);
    }
}
...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpXOHF4p/test.v", 198, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpXOHF4p/test.v", 198, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpXOHF4p/test.v", 198, "", "Active region did not converge.");
            }
