...
VL_ATTR_COLD void Vsubtractor___024root___eval_static__TOP(Vsubtractor___024root* vlSelf);
...
VL_ATTR_COLD void Vsubtractor___024root___eval_static(Vsubtractor___024root* vlSelf) {
    ...
    // Body
    Vsubtractor___024root___eval_static__TOP(vlSelf);
}

VL_ATTR_COLD void Vsubtractor___024root___eval_static__TOP(Vsubtractor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___present_state = 1U;
}

VL_ATTR_COLD void Vsubtractor___024root___eval_initial__TOP(Vsubtractor___024root* vlSelf);
...
VL_ATTR_COLD void Vsubtractor___024root___eval_initial(Vsubtractor___024root* vlSelf) {
    ...
    // Body
    Vsubtractor___024root___eval_initial__TOP(vlSelf);
...
VL_ATTR_COLD void Vsubtractor___024root___eval_initial__TOP(Vsubtractor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root___eval_initial__TOP\n"); );
    // Body
    vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___next_state = 1U;
}
...
#endif
            VL_FATAL_MT("/tmp/nix-shell.dClVll/.tmpXOHF4p/test.v", 198, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vsubtractor___024root___ctor_var_reset(Vsubtractor___024root* vlSelf) {
    ...
    vlSelf->start_port = VL_RAND_RESET_I(1);
    vlSelf->Pd5 = VL_RAND_RESET_I(32);
    vlSelf->Pd6 = VL_RAND_RESET_I(32);
    vlSelf->done_port = VL_RAND_RESET_I(1);
    vlSelf->return_port = VL_RAND_RESET_I(32);
    vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___present_state = VL_RAND_RESET_I(1);
    vlSelf->subtractor__DOT___subtractor_i0__DOT__Controller_i__DOT___next_state = VL_RAND_RESET_I(1);
