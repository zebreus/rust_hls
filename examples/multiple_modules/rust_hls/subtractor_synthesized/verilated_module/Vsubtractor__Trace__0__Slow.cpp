...
VL_ATTR_COLD void Vsubtractor___024root__trace_init_sub__TOP__0(Vsubtractor___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_init_sub__TOP__0\n"); );
    // Init
    ...
    tracep->declBus(c+5,0,"Pd6",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->pushPrefix("subtractor", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+1,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+2,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+3,0,"start_port",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+4,0,"Pd5",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vsubtractor___024root__trace_init_top(Vsubtractor___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_init_top\n"); );
    // Body
    Vsubtractor___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vsubtractor___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vsubtractor___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vsubtractor___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vsubtractor___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vsubtractor___024root__trace_register(Vsubtractor___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_register\n"); );
    // Body
    tracep->addConstCb(&Vsubtractor___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vsubtractor___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vsubtractor___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vsubtractor___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vsubtractor___024root__trace_const_0_sub_0(Vsubtractor___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vsubtractor___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_const_0\n"); );
    // Init
    Vsubtractor___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vsubtractor___024root*>(voidSelf);
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vsubtractor___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vsubtractor___024root__trace_const_0_sub_0(Vsubtractor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_const_0_sub_0\n"); );
    // Init
...
VL_ATTR_COLD void Vsubtractor___024root__trace_full_0_sub_0(Vsubtractor___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vsubtractor___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_full_0\n"); );
    // Init
    Vsubtractor___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vsubtractor___024root*>(voidSelf);
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vsubtractor___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vsubtractor___024root__trace_full_0_sub_0(Vsubtractor___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vsubtractor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsubtractor___024root__trace_full_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    ...
    bufp->fullIData(oldp+5,(vlSelf->Pd6),32);
