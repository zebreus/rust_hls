...
// rust_hls hash: "fa9f58d57aa5a803dea91bf06cca1d07"

use ::rust_hdl::prelude::*;
#[allow(dead_code, unused)]
mod subtractor_verilated {
    use std::path::Path;
    mod ffi {
        #[allow(non_camel_case_types)]
        pub enum subtractor {}
        extern {
            pub fn subtractor_new() -> *mut subtractor;
            pub fn subtractor_delete(subtractor: *mut subtractor);
            pub fn subtractor_eval(subtractor: *mut subtractor);
            pub fn subtractor_final(subtractor: *mut subtractor);
            pub fn subtractor_set_clk(
                subtractor: *mut subtractor,
                v: ::std::os::raw::c_uchar,
            );
            pub fn subtractor_set_reset(
                subtractor: *mut subtractor,
                v: ::std::os::raw::c_uchar,
            );
            pub fn subtractor_set_start_port(
                subtractor: *mut subtractor,
                v: ::std::os::raw::c_uchar,
            );
            pub fn subtractor_set_Pd5(
                subtractor: *mut subtractor,
                v: ::std::os::raw::c_uint,
            );
            pub fn subtractor_set_Pd6(
                subtractor: *mut subtractor,
                v: ::std::os::raw::c_uint,
            );
            pub fn subtractor_get_done_port(
                subtractor: *mut subtractor,
            ) -> ::std::os::raw::c_uchar;
            pub fn subtractor_get_return_port(
                subtractor: *mut subtractor,
            ) -> ::std::os::raw::c_uint;
        }
    }
    pub struct SubtractorVerilated(*mut ffi::subtractor, Option<u32>);
    impl Default for SubtractorVerilated {
        fn default() -> Self {
            let ptr = unsafe { ffi::subtractor_new() };
            assert!(! ptr.is_null());
            SubtractorVerilated(ptr, None)
        }
    }
    impl Drop for SubtractorVerilated {
        fn drop(&mut self) {
            unsafe {
                ffi::subtractor_delete(self.0);
            }
        }
    }
    #[allow(dead_code, non_snake_case)]
    impl SubtractorVerilated {
        pub fn set_clk(&mut self, v: u8) {
            unsafe {
                ffi::subtractor_set_clk(self.0, v);
            }
        }
        pub fn set_reset(&mut self, v: u8) {
            unsafe {
                ffi::subtractor_set_reset(self.0, v);
            }
        }
        pub fn set_start_port(&mut self, v: u8) {
            unsafe {
                ffi::subtractor_set_start_port(self.0, v);
            }
        }
        pub fn set_Pd5(&mut self, v: u32) {
            unsafe {
                ffi::subtractor_set_Pd5(self.0, v);
            }
        }
        pub fn set_Pd6(&mut self, v: u32) {
            unsafe {
                ffi::subtractor_set_Pd6(self.0, v);
            }
        }
        pub fn done_port(&self) -> u8 {
            unsafe { ffi::subtractor_get_done_port(self.0) }
        }
        pub fn return_port(&self) -> u32 {
            unsafe { ffi::subtractor_get_return_port(self.0) }
        }
        pub fn eval(&mut self) {
            unsafe {
                ffi::subtractor_eval(self.0);
            }
        }
        pub fn finish(&mut self) {
            unsafe {
                ffi::subtractor_final(self.0);
            }
        }
...
pub struct Subtractor {
    ...
    verilated_module: ::std::sync::Arc<
        ::std::sync::Mutex<self::subtractor_verilated::SubtractorVerilated>,
    >,
}
unsafe impl Send for Subtractor {}
#[automatically_derived]
impl ::rust_hdl::prelude::block::Block for Subtractor {
...
#[automatically_derived]
impl ::rust_hdl::prelude::Logic for Subtractor {
    fn update(&mut self) {
    ...
    fn hdl(&self) -> ::rust_hdl::prelude::Verilog {
        ::rust_hdl::prelude::Verilog::Wrapper(::rust_hdl::prelude::Wrapper {
            code: "subtractor subtractor_inst(.clk(clk), .reset(reset), .start_port(start_port), .Pd5(a), .Pd6(b), .done_port(done_port), .return_port(return_port));"
                .into(),
            cores: "// \n// Politecnico di Milano\n// Code created using PandA - Version: PandA 2023.12 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2024-01-07T21:06:04\n// /sbin/bambu executed with: /sbin/bambu --simulator=VERILATOR --top-fname=subtractor --clock-name=clk --compiler=I386_CLANG16 result.ll \n// \n// Send any bug to: panda-info@polimi.it\n// ************************************************************************\n// The following text holds for all the components tagged with PANDA_LGPLv3.\n// They are all part of the BAMBU/PANDA IP LIBRARY.\n// This library is free software; you can redistribute it and/or\n// modify it under the terms of the GNU Lesser General Public\n// License as published by the Free Software Foundation; either\n// version 3 of the License, or (at your option) any later version.\n// \n// This library is distributed in the hope that it will be useful,\n// but WITHOUT ANY WARRANTY; without even the implied warranty of\n// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU\n// Lesser General Public License for more details.\n// \n// You should have received a copy of the GNU Lesser General Public\n// License along with the PandA framework; see the files COPYING.LIB\n// If not, see <http://www.gnu.org/licenses/>.\n// ************************************************************************\n\n\n`ifdef __ICARUS__\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef VERILATOR\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef MODEL_TECH\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef VCS\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef NCVERILOG\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef XILINX_SIMULATOR\n  `define _SIM_HAVE_CLOG2\n`endif\n`ifdef XILINX_ISIM\n  `define _SIM_HAVE_CLOG2\n`endif\n\n// This component is part of the BAMBU/PANDA IP LIBRARY\n// Copyright (C) 2004-2023 Politecnico di Milano\n// Author(s): Fabrizio Ferrandi <fabrizio.ferrandi@polimi.it>\n// License: PANDA_LGPLv3\n`timescale 1ns / 1ps\nmodule ui_minus_expr_FU(in1,\n  in2,\n  out1);\n  parameter BITSIZE_in1=1,\n    BITSIZE_in2=1,\n    BITSIZE_out1=1;\n  // IN\n  input [BITSIZE_in1-1:0] in1;\n  input [BITSIZE_in2-1:0] in2;\n  // OUT\n  output [BITSIZE_out1-1:0] out1;\n  assign out1 = in1 - in2;\nendmodule\n\n// Datapath RTL description for subtractor\n// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.\n// Author(s): Component automatically generated by bambu\n// License: THIS COMPONENT IS PROVIDED \"AS IS\" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n`timescale 1ns / 1ps\nmodule datapath_subtractor(clock,\n  reset,\n  in_port_Pd5,\n  in_port_Pd6,\n  return_port);\n  // IN\n  input clock;\n  input reset;\n  input [31:0] in_port_Pd5;\n  input [31:0] in_port_Pd6;\n  // OUT\n  output [31:0] return_port;\n  // Component and signal declarations\n  wire [31:0] out_ui_minus_expr_FU_32_32_32_3_i0_fu_subtractor_428394_428414;\n  \n  ui_minus_expr_FU #(.BITSIZE_in1(32),\n    .BITSIZE_in2(32),\n    .BITSIZE_out1(32)) fu_subtractor_428394_428414 (.out1(out_ui_minus_expr_FU_32_32_32_3_i0_fu_subtractor_428394_428414),\n    .in1(in_port_Pd5),\n    .in2(in_port_Pd6));\n  // io-signal post fix\n  assign return_port = out_ui_minus_expr_FU_32_32_32_3_i0_fu_subtractor_428394_428414;\n\nendmodule\n\n// FSM based controller description for subtractor\n// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.\n// Author(s): Component automatically generated by bambu\n// License: THIS COMPONENT IS PROVIDED \"AS IS\" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n`timescale 1ns / 1ps\nmodule controller_subtractor(done_port,\n  clock,\n  reset,\n  start_port);\n  // IN\n  input clock;\n  input reset;\n  input start_port;\n  // OUT\n  output done_port;\n  parameter [0:0] S_0 = 1'b1;\n  reg [0:0] _present_state=S_0, _next_state;\n  reg done_port;\n  \n  always @(posedge clock)\n    if (reset == 1'b0) _present_state <= S_0;\n    else _present_state <= _next_state;\n  \n  always @(*)\n  begin\n    done_port = 1'b0;\n    case (_present_state)\n      S_0 :\n        if(start_port == 1'b1)\n        begin\n          _next_state = S_0;\n          done_port = 1'b1;\n        end\n        else\n        begin\n          _next_state = S_0;\n        end\n      default :\n        begin\n          _next_state = S_0;\n        end\n    endcase\n  end\nendmodule\n\n// Top component for subtractor\n// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.\n// Author(s): Component automatically generated by bambu\n// License: THIS COMPONENT IS PROVIDED \"AS IS\" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n`timescale 1ns / 1ps\nmodule _subtractor(clock,\n  reset,\n  start_port,\n  done_port,\n  Pd5,\n  Pd6,\n  return_port);\n  // IN\n  input clock;\n  input reset;\n  input start_port;\n  input [31:0] Pd5;\n  input [31:0] Pd6;\n  // OUT\n  output done_port;\n  output [31:0] return_port;\n  // Component and signal declarations\n  \n  controller_subtractor Controller_i (.done_port(done_port),\n    .clock(clock),\n    .reset(reset),\n    .start_port(start_port));\n  datapath_subtractor Datapath_i (.return_port(return_port),\n    .clock(clock),\n    .reset(reset),\n    .in_port_Pd5(Pd5),\n    .in_port_Pd6(Pd6));\n\nendmodule\n\n// This component is part of the BAMBU/PANDA IP LIBRARY\n// Copyright (C) 2004-2023 Politecnico di Milano\n// Author(s): Fabrizio Ferrandi <fabrizio.ferrandi@polimi.it>\n// License: PANDA_LGPLv3\n`timescale 1ns / 1ps\nmodule ui_view_convert_expr_FU(in1,\n  out1);\n  parameter BITSIZE_in1=1,\n    BITSIZE_out1=1;\n  // IN\n  input [BITSIZE_in1-1:0] in1;\n  // OUT\n  output [BITSIZE_out1-1:0] out1;\n  assign out1 = in1;\nendmodule\n\n// Minimal interface for function: subtractor\n// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.\n// Author(s): Component automatically generated by bambu\n// License: THIS COMPONENT IS PROVIDED \"AS IS\" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n`timescale 1ns / 1ps\nmodule subtractor(clk,\n  reset,\n  start_port,\n  Pd5,\n  Pd6,\n  done_port,\n  return_port);\n  // IN\n  input clk;\n  input reset;\n  input start_port;\n  input [31:0] Pd5;\n  input [31:0] Pd6;\n  // OUT\n  output done_port;\n  output [31:0] return_port;\n  // Component and signal declarations\n  wire [31:0] out_return_port_ui_view_convert_expr_FU;\n  \n  _subtractor _subtractor_i0 (.done_port(done_port),\n    .return_port(out_return_port_ui_view_convert_expr_FU),\n    .clock(clk),\n    .reset(reset),\n    .start_port(start_port),\n    .Pd5(Pd5),\n    .Pd6(Pd6));\n  ui_view_convert_expr_FU #(.BITSIZE_in1(32),\n    .BITSIZE_out1(32)) return_port_ui_view_convert_expr_FU (.out1(return_port),\n    .in1(out_return_port_ui_view_convert_expr_FU));\n\nendmodule\n\n\n"
                .into(),
        })
    }
}
